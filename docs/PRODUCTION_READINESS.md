...
- Protocol breadth:
  ...
  - typed EWS high-level workflows beyond the current `GetFolder`,
    ...
    metadata-only `calendar.list` read paths plus raw `EWSRequest` escape
    hatch;
